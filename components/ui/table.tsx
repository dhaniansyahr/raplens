...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 align-middle text-center font-normal text-black text-xl [&:has([role=checkbox])]:pr-0 dark:text-neutral-400",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "p-4 align-middle font-extralight text-center [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
